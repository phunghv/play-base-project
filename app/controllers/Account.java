...
public class Account extends Controller {
    ...
    private final MyUsernamePasswordAuthProvider myUsrPasswordProvider;

    private final MessagesApi msg;

    @Inject
    public Account(final PlayAuthenticate auth, final UserProvider userProvider,
                   final MyUsernamePasswordAuthProvider myUsrPasswordProvider,
                   final FormFactory formFactory, final MessagesApi msg) {
        this.auth = auth;
        this.userProvider = userProvider;
        this.myUsrPasswordProvider = myUsrPasswordProvider;
    ...
    public Result verifyEmail() {
        ...
        if (user.emailValidated) {
            ...
            flash(Application.FLASH_MESSAGE_KEY, this.msg.preferred(request()).at(
                    ...
                    user.email));
            this.myUsrPasswordProvider.sendVerifyEmailMailingAfterSignup(user, ctx());
        } else {
            flash(Application.FLASH_MESSAGE_KEY, this.msg.preferred(request()).at(
